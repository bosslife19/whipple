        ...
        <Text style={dicestyles.subDescription}>Create {GameName} Game</Text>
          ...
          <View style={dicestyles.row}>
              ...
              <View style={dicestyles.card}>
                  ...
                  <View style={{ flexDirection: 'row', gap: 20 }}>
                      <Animated.View style={[dicestyles.diceBox, { transform: [{ rotate: spin1 }] }]}>
                          <View style={dicestyles.diceFace}>{getDots(face1)}</View>
                      </Animated.View>
                      {diceType === 'double' && (
                          <Animated.View style={[dicestyles.diceBox, { transform: [{ rotate: spin2 }] }]}>
                  ...
                  <View style={dicestyles.resultInfo}>
                      ...
                      <Text style={[dicestyles.odds,{fontWeight:'600',fontSize:16}]}>Total: {diceType === 'double' ? face1 + face2 : face1}</Text>
                  ...
                  <TouchableOpacity style={dicestyles.button} onPress={rollDice}>
                      <Svg width={20} height={20} viewBox="0 0 24 24" stroke="white">
                          ...
                          <Path d="M17.92 14l3.5-3.5a2.24 2.24 0 0 0 0-3l-5-4.92a2.24 2.24 0 0 0-3 0L10 6" stroke="white" />
                      </Svg>
          ...
          <View style={dicestyles.card}>
              ...
              <Text style={dicestyles.description}>
                  Roll the dice and set your stake. Players will bet against your result with odds of {getOdds()}.
                  If they correctly guess your roll, they win. If they guess wrong, you win.
              </Text>
          </View>
      </ScrollView>
    </View>
